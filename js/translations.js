...
const translations = {
    ...
    uz: {
        ...
        'nav.contact': 'ALOQA',
        'nav.brand': 'Oʻzbekiston Open Source Yuzlari',
        
        // Home Page
        'home.title': 'Oʻzbekiston Open Source Yuzlari',
        'home.tagline': 'Oʻzbekistonda ochiq kodli dasturiy taʼminot rivojlanishi va taraqqiyoti ortidagi odamlarning davom etayotgan fotografik hujjatlashtiruvi.',
        'home.comingSoon': 'Tez Orada',
        'home.gathering': 'Hozirda biz Oʻzbekistonda ochiq kodli dasturlash hissa qoʻshuvchilarning hikoyalari va portretlarini yigʻmoqdamiz.',
        'home.submitLink': 'Nomzod taklif qiling',
        'home.getStarted': 'bizga boshlashda yordam bering!',
        
        // About Page
        'about.title': 'Loyiha Haqida',
        'about.mission': 'Bizning Maqsadimiz',
        'about.missionText1': 'Oʻzbekiston Open Source Yuzlari - bu Oʻzbekiston va kengroq Markaziy Osiyo mintaqasida ochiq kodli dasturiy taʼminot rivojlanishi va taraqqiyoti ortidagi odamlarni nishonlaydigan davom etayotgan fotografik hujjatlashtirish loyihasidir.',
        'about.missionText2': 'Peter Adamsning asl',
        'about.missionText3': 'loyihasidan ilhomlangan holda, biz mahalliy ochiq kodli jamiyatimizning insoniy hikoyalari, sadoqati va innovatsiyasini koʻrsatishni maqsad qilganmiz.',
        'about.why': 'Nima Uchun Bu Muhim',
        'about.whyText1': 'Ochiq kodli dasturiy taʼminot dunyoni oʻzgartirdi, ammo bu inqilobiy loyihalar ortidagi yuzlar koʻpincha koʻrinmaydi. Ushbu loyiha Oʻzbekistonda texnologiya kelajagini qurayotgan dasturchilarga, qoʻllab-quvvatlovchilarga, himoyachilarga va hissa qoʻshuvchilarga alohida eʼtibor qaratadi.',
        'about.whyText2': 'Toshkentdan Samarqandgacha, Buxorodan Xivagacha, iqtidorli dasturchlar global ochiq kodli loyihalarga hissa qoʻshmoqda va mahalliy hamda xalqaro muammolarni hal qilish uchun innovatsion yechimlar yaratmoqda.',
        'about.getInvolved': 'Ishtirok Eting',
        'about.involvedText1': 'Oʻzbekistonda ochiq kodli dasturlashga muhim hissa qoʻshayotgan biror kishini tanaysizmi? Biz ularni namoyish qilishni xohlaymiz! Bizning',
        'about.involvedText2': 'taklif sahifamizga',
        'about.involvedText3': 'tashrif buyurib, ushbu loyiha uchun odam nomzod qiling.',
        'about.involvedText4': "Ular mashhur loyihani qoʻllab-quvvatlayotganmi, yirik frameworklarga hissa qoʻshayotganmi yoki jamiyatga xizmat qiluvchi vositalarni yaratayotganmi, biz ularning hikoyasini baham koʻrishni xohlaymiz.",
        'about.credits': 'Minnatdorchilik',
        'about.creditsText': 'Ushbu loyiha Peter Adamsning',
        
        // Submit Page
        'submit.title': 'Odam Taklif Qilish',
        'submit.intro': 'Oʻzbekistonda ochiq kodli dasturlashga muhim hissa qoʻshayotgan kishini tanaysizmi? Ularni ushbu loyihada namoyish qilish uchun nomzod qiling!',
        ...
        'submit.methodHelp': 'GitHub PR jamiyatga koʻrib chiqish va muhokama qilish imkonini beradi. Email shaxsiy takliflar uchun.',
        ...
        'submit.location': 'Oʻzbekistondagi Joylashuv *',
        ...
        'submit.projectsPlaceholder': 'Ular qoʻllab-quvvatlayotgan yoki hissa qoʻshayotgan asosiy ochiq kodli loyihalarni sanang',
        'submit.impact': 'Taʼsir va Yutuqlar *',
        'submit.impactPlaceholder': 'Ochiq kodli jamiyatga ularning taʼsirini, eʼtiborga molik yutuqlarini yoki nima uchun namoyish qilinishi kerakligini tasvirlab bering',
        'submit.links': 'Tegishli Havolalar',
        'submit.linksPlaceholder': 'GitHub profili, shaxsiy veb-sayt, loyiha havollari va boshqalar (har bir qatorda bittadan)',
        ...
        'submit.photoUrl': 'Yoki Rasm URL manzilini Bering',
        'submit.photoUrlPlaceholder': 'https://example.com/photo.jpg',
        'submit.photoUrlHelp': 'Agar yuklay olmasangiz, rasm URL manzilini bering (Dropbox, Google Drive va boshqalar)',
        'submit.submitterTitle': 'Sizning Maʼlumotlaringiz',
        'submit.yourName': 'Sizning Ismingiz *',
        'submit.yourEmail': 'Sizning Emailingiz *',
        ...
        'submit.nextText': "Nomzodni yuborganingizdan soʻng, biz maʼlumotlarni koʻrib chiqamiz va fotosurat va intervyu uchun nomzod bilan bogʻlanamiz. Barcha takliflar shaffoflik va jamiyat ishtiroki uchun bizning GitHub omborimizda GitHub Issues sifatida yigʻiladi.",
        
        // Contact Page
        'contact.title': 'Aloqa',
        'contact.getInTouch': 'Bogʻlaning',
        ...
        'contact.contributingText': 'Bu loyiha ochiq kodli! Siz quyidagilar orqali hissa qoʻshishingiz mumkin:',
        'contact.contribute1': 'Namoyish qilish uchun odamlar nomzodini taklif qilish',
        'contact.contribute2': 'Veb-sayt kodi va dizaynini yaxshilash',
        'contact.contribute3': 'Loyihani tarmoqingizda baham koʻrish',
        'contact.contribute4': 'Fikr va takliflar berish',
        ...
        'contact.media': 'Ommaviy Axborot Vositalari',
        'contact.mediaText': 'Ushbu loyihani yoritishdan manfaatdor jurnalistlar va ommaviy axborot vositalari mutaxassislari email orqali murojaat qilishlari mumkin. Biz yuqori sifatli rasmlar va namoyish qilingan shaxslar haqida qoʻshimcha maʼlumot berishdan xursandmiz.',
        
        // Footer
        'footer.copyright': '© 2025 Oʻzbekiston Open Source Yuzlari. Barcha huquqlar himoyalangan.',
        
        // Form Messages
        'form.photoTooLarge': 'Rasm juda katta! Iltimos, 5MB dan kichik faylni yuklang.',
        'form.photoWrongType': 'Iltimos, JPG yoki PNG rasmini yuklang.',
        'form.githubSuccess': 'Nomzod taklifi masalasini yaratish uchun GitHub ochilmoqda.',
        'form.githubPhotoNote': "Eslatma: Rasm faylini GitHub masalasiga qoʻlda biriktirish kerak boʻladi (izoh maydoniga sudrab tashlang).",
        'form.githubPhotoUrl': 'Rasm URL manzili masalaga kiritilgan.',
        'form.githubReview': 'Masala jamiyat tomonidan koʻrib chiqiladi!',
        'form.emailSuccess': 'Nomzodni yuborish uchun email mijozingiz ochilmoqda.',
